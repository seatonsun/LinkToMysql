...
if __name__ == '__main__':
    ...
    company_research_sxcx("1", "京东")
    company_research_sxcx("2", "小红")
    # company_research_sxcx("3", "小红")
    ####下面的函数接收的是上面函数穿下来的company_id,并将对应的事件属性存到 新建的 本地DB表中
    company_id_insert_sxcx(company_research_sxcx("1", "京东"))
    company_id_insert_sxcx(company_research_sxcx("2", "小红"))
    db.close()
    # company_research_sxcx(2, "小酒")
